...
public class ImageRemarkUtil {
    ...
    public static void main(String[] args) {
        String srcImgPath = "Q:/1.jpg";
        String logoText = "复 印 无 效";
        String iconPath = "Q:/2.jpg";

        String targerTextPath = "Q:/qie_text.jpg";
        String targerTextPath2 = "Q:/qie_text_rotate.jpg";

        String targerIconPath = "Q:/qie_icon.jpg";
        String targerIconPath2 = "Q:/qie_icon_rotate.jpg";
